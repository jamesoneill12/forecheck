...
AgentDojo transfer is call-level reading is undetermined absent a
payload-deletion counterfactual with the call held fixed.
...
external cells: the right fields help, generic ones hurt. Calibration does not transfer (macro ECE
