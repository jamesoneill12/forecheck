...
models that are \emph{given} the context use it. A zero-shot safety model
and the acting agent, prompted with the same entitlements and policy text,
do not (\S\ref{sec:identity}), with the caveat that we cannot fully
separate a capability gap from a prompting mismatch. A
